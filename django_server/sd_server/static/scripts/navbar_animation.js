...
function nav_bar_slide_left(){
    ...
    translate_left_or_right('.clicked_sandwich_menu', 500, 500, 'linear');
    
    setTimeout(() => {
        $('.clicked_sandwich_menu').css({'background-color':'#D3450D'});
        $('.clicked_sandwich_menu nav ul li a').css({'color':'white'});
        translate_left_or_right('.clicked_sandwich_menu', 0, 1000, 'linear');
        }, 500);
...
function nav_bar_slide_right(){
    translate_left_or_right('.clicked_sandwich_menu', 500, 1000, 'linear');
    setTimeout(() => {
